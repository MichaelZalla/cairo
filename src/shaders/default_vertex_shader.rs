...
pub static DefaultVertexShader: VertexShaderFn =
    |context: &ShaderContext, v: &DefaultVertexIn| -> DefaultVertexOut {
        ...
        let position_world_space = position * context.world_transform;
        ...
        out.position_view_space = (position * context.world_view_transform).to_vec3();

        // Projection-space position.

        out.position_projection_space = position * context.world_view_projection_transform;
